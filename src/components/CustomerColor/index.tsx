    ...
    >
      ...
      <div className="relative my-3">
        <div
          id="custred"
          title="red"
          className="inline-block p-3 ltr:mr-1.5 rtl:ml-1.5 bg-meta-1 hover:opacity-90 rounded-full cursor-pointer"
        ></div>
        <div
          id="custyellow"
          title="yellow"
          className="inline-block p-3 ltr:mr-1.5 rtl:ml-1.5 bg-meta-2 hover:opacity-90 rounded-full cursor-pointer"
        ></div>
        <div
          id="custgreen"
          title="green"
          className="inline-block p-3 ltr:mr-1.5 rtl:ml-1.5 bg-meta-3 hover:opacity-90 rounded-full cursor-pointer"
        ></div>
        <div
          id="custblue"
          title="blue"
